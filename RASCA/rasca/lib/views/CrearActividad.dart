                    ...
                    children: [
                      ...
                      Column(
                          ...
                          children: <Widget>[
                            ListTile(
                              title: Text(
                                "Fecha de Inicio: ${startDate.year},${startDate.month},${startDate.day}",
                            ...
                            ListTile(
                              title: Text(
                                "Fecha a finalizar: ${endDate.year},${endDate.month},${endDate.day}",
                                style: TextStyle(fontSize: 20),
                              ),
                              trailing: Icon(Icons.keyboard_arrow_down),
                              onTap: _endDate,
                                    ...
                                    onPressed: () {
                                      ...
                                      setState(() {
                                        if (_nombreController.text.length < 1)
                                          _nombreError =
                                              "Debe agregar un nombre a la actividad";
                                        else
                                          _nombreError = null;
                                      });
                                      setState(() {
                                        if (_CuposController.text.length < 1)
                                          _cuposError =
                                              "Debe agregar al menos 1 cupo a la actividad";
                                        else
                                          _cuposError = null;
                                      });
                                      setState(() {
